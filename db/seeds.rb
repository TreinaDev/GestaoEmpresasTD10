...
Department.create!(company_id: Company.first.id, name: 'rh', code: 'ABC123', description: 'Descrição do departamento de RH da rebase')

Position.create!(department_id: Department.first.id, name: 'gerente')

EmployeeProfile.create!(status: 'unblocked', department_id: Department.first.id, position_id: Position.first.id,
          user_id: manager.id)
EmployeeProfile.create!(status: 'unblocked', department_id: Department.first.id, position_id: Position.first.id,
          user_id: manager2.id)
EmployeeProfile.create!(status: 'unblocked', department_id: Department.first.id, position_id: Position.first.id,
