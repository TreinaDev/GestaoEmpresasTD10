...
feature 'Gerente vê histórico de recargas do funcionário' do
  scenario 'Com sucesso' do
    ...
    employee_profile = create(:employee_profile, :employee, name: 'Roberto Carlos Nascimento',
                                                            ...
                                                            card_status: true)
    recharge1 = RechargeHistory.create(value: 500, recharge_date: Time.zone.today, employee_profile:, creator: manager)
    RechargeHistory.create(value: 600, recharge_date: Time.zone.today, employee_profile:, creator: manager)
    RechargeHistory.create(value: 700, recharge_date: Time.zone.today, employee_profile:, creator: manager)
    ...
    expect(page).to have_content "Data: #{I18n.l(recharge1.recharge_date)}"
  end
