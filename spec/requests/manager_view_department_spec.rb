...
describe 'Gerente tenta acessar departamente de outra empresas', type: :request do
  it 'e é redirecionado para a página principal' do
    ...
    company2 = create(:company, brand_name: 'Monstros SA', domain: 'monstrossa.com', registration_number: '33400500000155', address: 'rua dos monstros 44', 
                      phone_number: '828888888', email: 'contato@monstrossa.com', corporate_name: 'Monstros Energia SA')
    ...
    manager_user_2 = create(:manager_user, email: "nome@#{company2.domain}", cpf: '09814576492')

    login_as(manager_user_2)

    get company_department_employee_profile_path(company_id: company.id, department_id: department.id, id: employee_profile.id)
